 ...
 * inputFolder   <string>  (optional) (default: `Fusion`) The folder under `Resources/Private` where to look for the entry files
...
export default [
    ...
    { packageName: "Vendor.Theme", filenames: ["Main.js", "TrackingOptions.js"], inline: true },
    { packageName: "Vendor.Slider", filenames: ["Main.js"] },
];
